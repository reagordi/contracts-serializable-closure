...
class InvalidSignatureException extends SystemException
{
    /**
     ...
     */
    public function __construct(string $message = 'Your serialized closure might have been modified or it\'s unsafe to be unserialized.', int $code = 500, $file = '', int $line = 0, ?Throwable $previous = null)
    {
    ...
    {
        return 'Invalid Signature Exception';
    }
}
